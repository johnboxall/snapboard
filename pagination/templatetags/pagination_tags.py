...
def do_autopaginate(parser, token):
    ...
    if 2 <= len(split) <= 4:
        ...
        raise template.TemplateSyntaxError('%r tag takes one required argument and two optional arguments' % split[0])
...
class AutoPaginateNode(template.Node):
    ...
    """
    def __init__(self, queryset_var, paginate_by=str(DEFAULT_PAGINATION), orphans=str(DEFAULT_ORPHANS)):
